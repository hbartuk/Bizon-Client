...
//import com.retrivedmods.wclient.game.module.misc.SpoofingModule // Убедитесь, что путь правильный, если SpoofingModule находится в д

// Импорт команд
import com.retrivedmods.wclient.game.command.impl.SledCommandругом месте
